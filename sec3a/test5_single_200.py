...
def objective(trial, X_train, Y_train, omega1_t_train, omega2_t_train, omega3_t_train, t_on_train, num_sys_train):
    ...
    """
    units = trial.suggest_int('units', 200, 200)  # Now optimizing units between 100 and 1000
...
results = train_optimal_esn_with_test(
    study_name='test5_single_study_200', 
...
with open('test5_single_results_500.json', mode='w') as f:
